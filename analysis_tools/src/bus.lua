...
if BUSES["GIO64"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/gio64/gr2.cpp",
		MAME_DIR .. "src/devices/bus/gio64/gr2.h",
		MAME_DIR .. "src/devices/bus/gio64/newport.cpp",
		MAME_DIR .. "src/devices/bus/gio64/newport.h",
		MAME_DIR .. "src/devices/bus/gio64/sgi_glaccel.cpp",
		MAME_DIR .. "src/devices/bus/gio64/sgi_glaccel.h",
